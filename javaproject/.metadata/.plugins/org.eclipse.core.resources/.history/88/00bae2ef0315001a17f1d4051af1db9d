...
public class GameStart extends JPanel {
	...
	public GameStart(){
		...
		String senemy2 = "../images/Android2.png";
		...
		try{
			...
			bex1 = ImageIO.read(iene1);
			bex2 = ImageIO.read(iene2);
		}catch(Exception e){
			e.printStackTrace();
		}
				...
				while(true){
					try{
						...
						if(intRandom < 0) {
							...
							intRandom = (int)(randomValue * 800)+700;
						}
					}catch(Exception E){
						E.printStackTrace();
					}
...
//		System.out.println(x);
		...
		case 0:
			System.out.println("깃발 0");
			g2d.drawImage(bex1, intRandom,y+188,this);
			eflag = 1;
			break;
		case 1:
			System.out.println("깃발 1");
			g2d.drawImage(bex2, intRandom,y+188,this);
			eflag = 0;
			break;
		}		
		switch(flag) {
