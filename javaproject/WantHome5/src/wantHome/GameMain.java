	...
	public class TestPane extends JPanel {
        ...
        public TestPane() {
            try {
                ...
                map1 = ImageIO.read(getClass().getResource("../images/map1.png"));
                map2 = ImageIO.read(getClass().getResource("../images/map2.png"));
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2d.drawImage(map1,x,0,this);
            g2d.drawImage(map2,x,300,this);
            g2d.drawImage(spider, 80, spiderBounds.y, this);
